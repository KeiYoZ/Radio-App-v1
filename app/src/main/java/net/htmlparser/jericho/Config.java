 ...
 * compatibility issues are stored in instances of the {@link CompatibilityMode} class.
...
public final class Config {
	...
	/**
	 * Determines the currently active {@linkplain CompatibilityMode compatibility mode}.
	 * <p>
	 * The default setting is {@link CompatibilityMode#IE} (MS Internet Explorer 6.0).
	 * <p>
	 * Must not be <code>null</code>.
	 */
